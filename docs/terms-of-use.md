...
## 3. Academic Responsibility & Disclaimer
...
*   **No Guarantee on Reminders:** While the app allows you to set reminders for lessons and exams, we do not guarantee that notifications will always fire correctly. Factors such as OS battery optimizations (Doze mode), device restarts, or technical glitches may prevent notifications.
*   **Limitation of Liability:** The developer of MyPrograms shall **NOT be held responsible** for:
    *   Missed classes or lectures.
    *   Forgotten exams or assignment deadlines.
    *   Academic failure or loss of scholarships/grades.
    *   Any financial or personal damages resulting from the use or inability to use the application.
...
We reserve the right to introduce cloud-based features in the future, such as:
*   Cloud synchronization via **Firebase**.
*   Collaborative features and user accounts.
    You will be notified of these changes, and your continued use of the app will signify your acceptance of any new terms related to these features.
...
*   Use the Service for any illegal activities or to store harmful content.
*   Interfere with the security-related features of the application.
...
## 8. Changes to Terms
We reserve the right, at our sole discretion, to modify or replace these Terms at any time. We will try to provide at least 30 days' notice before any new terms take effect if the changes are material.
